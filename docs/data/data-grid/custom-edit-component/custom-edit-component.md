...
<p class="description">Create your own edit component.</p>
...
To picture better, imagine an edit component with a combo, created following the normal [steps](#custom-edit-component).
